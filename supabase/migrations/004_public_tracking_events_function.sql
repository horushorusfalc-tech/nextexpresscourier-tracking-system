-- ============================================
-- Ensure public tracking RPC returns shipment + tracking events
-- Run this in Supabase SQL editor against your project.
-- ============================================

DROP FUNCTION IF EXISTS public.get_shipment_by_tracking_public(text);

CREATE FUNCTION public.get_shipment_by_tracking_public(p_tracking_number text)
RETURNS jsonb
LANGUAGE sql
STABLE
SECURITY DEFINER
